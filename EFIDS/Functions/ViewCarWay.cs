...
public class ViewCarWay
{
    ...
    [Column("wim_previous_filing_id")]
    public long? WimPreviousFilingId { get; set; }

    [Column("wim_previous_filing_position")]
    public int? WimPreviousFilingPosition { get; set; }

    [Column("wim_previous_filing_id_station")]
    public int? WimPreviousFilingIdStation { get; set; }

    [Column("wim_previous_filing_id_way")]
    public int? WimPreviousFilingIdWay { get; set; }

    [Column("wim_previous_filing_way_start", TypeName = "datetime")]
    public DateTime? WimPreviousFilingWayStart { get; set; }

    [Column("wim_previous_filing_way_end", TypeName = "datetime")]
    public DateTime? WimPreviousFilingWayEnd { get; set; }

    [Column("wim_previous_filing_id_outer_way")]
    public int? WimPreviousFilingIdOuterWay { get; set; }

    [Column("wim_previous_filing_outer_way_start", TypeName = "datetime")]
    public DateTime? WimPreviousFilingOuterWayStart { get; set; }

    [Column("wim_previous_filing_outer_way_end", TypeName = "datetime")]
    public DateTime? WimPreviousFilingOuterWayEnd { get; set; }

    [Column("wim_previous_filing_filing_start", TypeName = "datetime")]
    public DateTime? WimPreviousFilingFilingStart { get; set; }

    [Column("wim_previous_filing_filing_end", TypeName = "datetime")]
    public DateTime? WimPreviousFilingFilingEnd { get; set; }

    [Column("wio_previous_filing_id")]
    public long? WioPreviousFilingId { get; set; }

    [Column("previous_filing_id_operation")]
    public int? PreviousFilingIdOperation { get; set; }

    [Column("previous_filing_operation_name_ru")]
    [StringLength(50)]
    public string? PreviousFilingOperationNameRu { get; set; }

    [Column("previous_filing_operation_name_en")]
    [StringLength(50)]
    public string? PreviousFilingOperationNameEn { get; set; }

    [Column("previous_filing_operation_start", TypeName = "datetime")]
    public DateTime? PreviousFilingOperationStart { get; set; }

    [Column("previous_filing_operation_end", TypeName = "datetime")]
    public DateTime? PreviousFilingOperationEnd { get; set; }
