...
public partial class ViewIncomingCars
{
    ...
    [Column("arrival_car_id_outgoing_car")]
    public long? ArrivalCarIdOutgoingCar { get; set; }

    [Column("arrival_car_id_outgoing_uz_vagon")]
    public long? ArrivalCarIdOutgoingUzVagon { get; set; }

    [Column("arrival_car_wim_cur_id")]
    public long? ArrivalCarWimCurId { get; set; }

    [Column("arrival_car_wim_cur_id_wagon_internal_routes")]
    public long? ArrivalCarWimCurIdWagonInternalRoutes { get; set; }

    [Column("arrival_car_wim_cur_id_station")]
    public int? ArrivalCarWimCurIdStation { get; set; }

    [Column("arrival_car_wim_cur_station_name_ru")]
    [StringLength(50)]
    public string? ArrivalCarWimCurStationNameRu { get; set; }

    [Column("arrival_car_wim_cur_station_name_en")]
    [StringLength(50)]
    public string? ArrivalCarWimCurStationNameEn { get; set; }

    [Column("arrival_car_wim_cur_station_abbr_ru")]
    [StringLength(50)]
    public string? ArrivalCarWimCurStationAbbrRu { get; set; }

    [Column("arrival_car_wim_cur_station_abbr_en")]
    [StringLength(50)]
    public string? ArrivalCarWimCurStationAbbrEn { get; set; }

    [Column("arrival_car_wim_cur_id_way")]
    public int? ArrivalCarWimCurIdWay { get; set; }

    [Column("arrival_car_wim_cur_way_on_id_park")]
    public int? ArrivalCarWimCurWayOnIdPark { get; set; }

    [Column("arrival_car_wim_cur_way_num_ru")]
    [StringLength(20)]
    public string? ArrivalCarWimCurWayNumRu { get; set; }

    [Column("arrival_car_wim_cur_way_num_en")]
    [StringLength(20)]
    public string? ArrivalCarWimCurWayNumEn { get; set; }

    [Column("arrival_car_wim_cur_way_name_ru")]
    [StringLength(100)]
    public string? ArrivalCarWimCurWayNameRu { get; set; }

    [Column("arrival_car_wim_cur_way_name_en")]
    [StringLength(100)]
    public string? ArrivalCarWimCurWayNameEn { get; set; }

    [Column("arrival_car_wim_cur_way_abbr_ru")]
    [StringLength(50)]
    public string? ArrivalCarWimCurWayAbbrRu { get; set; }

    [Column("arrival_car_wim_cur_way_abbr_en")]
    [StringLength(50)]
    public string? ArrivalCarWimCurWayAbbrEn { get; set; }

    [Column("arrival_car_wim_cur_way_start", TypeName = "datetime")]
    public DateTime? ArrivalCarWimCurWayStart { get; set; }

    [Column("arrival_car_wim_cur_way_end", TypeName = "datetime")]
    public DateTime? ArrivalCarWimCurWayEnd { get; set; }

    [Column("arrival_car_wim_cur_id_outer_way")]
    public int? ArrivalCarWimCurIdOuterWay { get; set; }

    [Column("arrival_car_wim_cur_name_outer_way_ru")]
    [StringLength(150)]
    public string? ArrivalCarWimCurNameOuterWayRu { get; set; }

    [Column("arrival_car_wim_cur_name_outer_way_en")]
    [StringLength(150)]
    public string? ArrivalCarWimCurNameOuterWayEn { get; set; }

    [Column("arrival_car_wim_cur_outer_way_start", TypeName = "datetime")]
    public DateTime? ArrivalCarWimCurOuterWayStart { get; set; }

    [Column("arrival_car_wim_cur_outer_way_end", TypeName = "datetime")]
    public DateTime? ArrivalCarWimCurOuterWayEnd { get; set; }

    [Column("arrival_car_wim_cur_position")]
    public int? ArrivalCarWimCurPosition { get; set; }

    [Column("arrival_car_wim_cur_note")]
    [StringLength(250)]
    public string? ArrivalCarWimCurNote { get; set; }

    [Column("arrival_car_wim_cur_parent_id")]
    public long? ArrivalCarWimCurParentId { get; set; }

    [Column("arrival_car_wim_cur_id_wio")]
    public long? ArrivalCarWimCurIdWio { get; set; }

    [Column("arrival_car_wim_cur_num_sostav")]
    [StringLength(50)]
    public string? ArrivalCarWimCurNumSostav { get; set; }
    ...
    [StringLength(50)]
    public string ArrivalSostavCompositionIndex { get; set; } = null!;
    ...
    [StringLength(50)]
    public string ArrivalSostavCreateUser { get; set; } = null!;
    ...
    [Column("arrival_uz_vagon_id_arrival")]
    public long? ArrivalUzVagonIdArrival { get; set; }
    ...
    [StringLength(50)]
    public string? ArrivalUzVagonCreateUser { get; set; }
