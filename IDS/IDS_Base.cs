namespace IDS_
{
    ...
    public enum errors_base : int
    {
        ...
        input_position_error = -104,                // Ошибка, позиция указана не правильно
        ...
        error_value_load_vz = -455,                 // Ошибка, неверный формат или не все праметры заданы для создания загрузки ВЗ
        error_value_load_uz = -456,                 // Ошибка, неверный формат или не все праметры заданы для создания загрузки УЗ
        ...
        error_out_uz_doc_not_code_payer = -654,     // В документе на отправку не указан платильщик 
        ...
        not_usage_fee_period_detali_error_data = -772,      // Ошибка данных доп условия (несовместиммые или не корректные доп. условия) периода платы за пользования.
        ...
        not_usage_fee_of_db = -850,                         // Ошибка, в базе данных нет строки расчитаной платы за пользование
        ...
        way_not_crossing_uz = -2103,                        // Путь неимеет выход на УЗ
        way_is_not_null = -2104,                            // На пути стоят вагоны
        way_is_close = -2105,                               // Путь закрыт
        way_is_delete = -2106,                              // Путь удален и неиспользуется

        // Directory_ParkWays -2200..
        not_dir_park_of_db = -2201,                         // В базе данных нет указаного парка
