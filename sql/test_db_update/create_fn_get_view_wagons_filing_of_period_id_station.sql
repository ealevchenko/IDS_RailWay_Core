...
CREATE FUNCTION [IDS].[get_view_wagons_filing_of_period_id_station]
 (
	...
	[is_moving] [bit] NULL,
	[id_filing] [bigint] NOT NULL,
	[num_filing] [nvarchar](50) NOT NULL,
	[type_filing] [int] NOT NULL,
	[id_division_filing] [int] NOT NULL,
	...
	[create_filing] [datetime] NOT NULL,
	[create_user_filing] [nvarchar](50) NOT NULL,
	...
	[filing_condition_id_condition] [int] NULL,
	[filing_condition_name_ru] [nvarchar](100) NULL,
	[filing_condition_name_en] [nvarchar](100) NULL,
	[filing_condition_abbr_ru] [nvarchar](20) NULL,
	[filing_condition_abbr_en] [nvarchar](20) NULL,
	[filing_condition_red] [bit] NULL,
	[filing_id_loading_status] [int] NULL,
	[filing_loading_status_ru] [nvarchar](30) NULL,
	[filing_loading_status_en] [nvarchar](30) NULL,
	[filing_id_operation] [int] NULL,
	[filing_operation_name_ru] [nvarchar](50) NULL,
	[filing_operation_name_en] [nvarchar](50) NULL,
	[filing_operation_start] [datetime] NULL,
	[filing_operation_end] [datetime] NULL,
	[filing_id_organization_service] [int] NULL,
	[filing_organization_service_ru] [nvarchar](50) NULL,
	[filing_organization_service_en] [nvarchar](50) NULL,
	[filing_internal_doc_num] [nvarchar](20) NULL,
	[filing_id_weighing_num] [int] NULL,
	[filing_move_cargo_doc_received] [datetime] NULL,
	[filing_cargo_id_group] [int] NULL,
	[filing_cargo_group_name_ru] [nvarchar](50) NULL,
	[filing_cargo_group_name_en] [nvarchar](50) NULL,
	[filing_cargo_id_cargo] [int] NULL,
	[filing_cargo_name_ru] [nvarchar](50) NULL,
	[filing_cargo_name_en] [nvarchar](50) NULL,
	[filing_internal_cargo_id_group] [int] NULL,
	[filing_internal_cargo_group_name_ru] [nvarchar](50) NULL,
	[filing_internal_cargo_group_name_en] [nvarchar](50) NULL,
	[filing_internal_cargo_id_internal_cargo] [int] NULL,
	[filing_internal_cargo_name_ru] [nvarchar](50) NULL,
	[filing_internal_cargo_name_en] [nvarchar](50) NULL,
	[filing_vesg] [int] NULL,
	[filing_id_station_from_amkr] [int] NULL,
	[filing_station_from_amkr_name_ru] [nvarchar](50) NULL,
	[filing_station_from_amkr_name_en] [nvarchar](50) NULL,
	[filing_station_from_amkr_abbr_ru] [nvarchar](50) NULL,
	[filing_station_from_amkr_abbr_en] [nvarchar](50) NULL,
	[filing_id_division_from] [int] NULL,
	[filing_division_from_code] [nvarchar](5) NULL,
	[filing_division_from_name_ru] [nvarchar](250) NULL,
	[filing_division_from_name_en] [nvarchar](250) NULL,
	[filing_division_from_abbr_ru] [nvarchar](50) NULL,
	[filing_division_from_abbr_en] [nvarchar](50) NULL,
	[filing_id_wim_load] [bigint] NULL,
	[filing_id_wim_redirection] [bigint] NULL,
	[filing_code_external_station] [int] NULL,
	[filing_external_station_on_name_ru] [nvarchar](50) NULL,
	[filing_external_station_on_name_en] [nvarchar](50) NULL,
	[filing_id_station_on_amkr] [int] NULL,
	[filing_station_on_amkr_name_ru] [nvarchar](50) NULL,
	[filing_station_on_amkr_name_en] [nvarchar](50) NULL,
	[filing_station_on_amkr_abbr_ru] [nvarchar](50) NULL,
	[filing_station_on_amkr_abbr_en] [nvarchar](50) NULL,
	[filing_id_division_on] [int] NULL,
	[filing_division_on_code] [nvarchar](5) NULL,
	[filing_division_on_name_ru] [nvarchar](250) NULL,
	[filing_division_on_name_en] [nvarchar](250) NULL,
	[filing_division_on_abbr_ru] [nvarchar](50) NULL,
	[filing_division_on_abbr_en] [nvarchar](50) NULL,
	[filing_move_cargo_create] [datetime] NULL,
	[filing_move_cargo_create_user] [nvarchar](50) NULL,
	[filing_move_cargo_change] [datetime] NULL,
	[filing_move_cargo_change_user] [nvarchar](50) NULL,
	[filing_move_cargo_close] [datetime] NULL,
	[filing_move_cargo_close_user] [nvarchar](50) NULL
	)
	AS
	BEGIN
